...
## 
## Makefile     : foo_rtw.mk
## Generated on : Fri May 24 15:09:50 2024
...
PRODUCT_NAME              = foo
MAKEFILE                  = foo_rtw.mk
MATLAB_ROOT               = C:/MATLAB/R2023b
MATLAB_BIN                = C:/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Github/MATLAB/Others/HXML/A_
...
# Toolchain Name:          Emscripten v3.1.60 | gmake (64-bit Windows)
# Supported Version(s):    
...
SUPPORTPACKAGEINCLUDE = D:\Github\MATLAB\Others\HXML\Source\GenerateJavaScriptUsingMATLABCoder\cpp\include
SUPPORTPACKAGESRC     = D:\Github\MATLAB\Others\HXML\Source\GenerateJavaScriptUsingMATLABCoder\cpp\src
...
SRCS = $(START_DIR)/codegen/dll/foo/rt_nonfinite.cpp $(START_DIR)/codegen/dll/foo/rtGetNaN.cpp $(START_DIR)/codegen/dll/foo/rtGetInf.cpp $(START_DIR)/codegen/dll/foo/foo_initialize.cpp $(START_DIR)/codegen/dll/foo/foo_terminate.cpp $(START_DIR)/codegen/dll/foo/foo.cpp $(START_DIR)/codegen/dll/foo/permute.cpp $(START_DIR)/codegen/dll/foo/imbinarize.cpp
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o foo_initialize.o foo_terminate.o foo.o permute.o imbinarize.o
...
permute.o : $(START_DIR)/codegen/dll/foo/permute.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


imbinarize.o : $(START_DIR)/codegen/dll/foo/imbinarize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
